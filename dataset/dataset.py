...
class Aircraft(VisionDataset):
    ...
    img_folder = os.path.join('FGVCAircraft', 'data', 'images')
    ...
    def __init__(self, root, train=True, class_type='variant', transform=None, target_transform=None, download=False,
        ...
        self.seed = seed
        self.mean = [0.48933587508932375,
                     0.5183537408957618, 0.5387914411673883]
        self.std = [0.22388883112804625,
                    0.21641635409388751, 0.24615605842636115]
        ...
        self.split = split
        self.root = root
        self.classes_file = os.path.join(self.root, 'FGVCAircraft', 'data',
            ...
            for line in all_lines:
                ...
                if _class != pre_class:
                    ...
                    if pre_class not in samples_with_class:
                        samples_with_class[pre_class] = self.filter_size_per_class(
                            class_sample)
                    else:
                        samples_with_class[pre_class].extend(
                            self.filter_size_per_class(class_sample))
                    class_sample = []
                    pre_class = _class
